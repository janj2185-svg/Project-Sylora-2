...
11. **Production deploy on Hetzner** — code is on `main`; live VPS `77.42.42.246` still needs secure SSH (`PROD_SSH_USER` / `PROD_SSH_PRIVATE_KEY`, optional port/path). See `docs/DEPLOY-HETZNER.md`. Does **not** block further product development.
