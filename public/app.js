...
let syloraCapabilities=null;let syloraVoiceId=localStorage.getItem('sylora_voice_id')||'';
...
async function renderAI(speakText=''){
  ...
  const availableVoices=('speechSynthesis'in window?window.speechSynthesis.getVoices():[]).filter(v=>/^(uk|pl|en|de|ru)/i.test(v.lang||''));
