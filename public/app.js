...
async function renderLive(){
  ...
  document.querySelectorAll('[data-live-setup]').forEach(button=>button.onclick=()=>{const target=button.dataset.liveSetup;if(target==='login')return state.me?toast('Вхід виконано'):renderAuth();if(target==='studio')return nav('studio');state.liveTab='create';renderLive()});
