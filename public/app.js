...
function renderMore(){
  const groups=[
    {title:'Особисте й безпека',copy:'Акаунт, ідентичність, AI та контроль даних.',items:[['profile','○','Акаунт і профіль','Ім’я, мова, гаманець і статистика.'],['identity','◈','SYLORA Identity','Навички, портфоліо та рівні приватності.'],['ai','✦','Sylora AI','Пам’ять, дозволи й прозора історія дій.'],['dashboard','▣','Personal Dashboard','Today · Tasks · Goals · Continuity.'],['security','⛨','Центр безпеки','Приватність, експорт даних і provenance.']]},
    {title:'Творчість і спілкування',copy:'Робочі поверхні, медіа та ваші кола.',items:[['canvas','▭','Sylora Canvas','Документи, плани та дослідження.'],['messages','◌','Комунікації','Приватні повідомлення й дзвінки.'],['videos','▻','Медіа','Відео та медіа-пайплайн.'],['gifts','♢','Gift Gallery','Подарунки для LIVE і Battles.'],['communities','◎','Спільноти','Кола, канали й простори.']]},
    {title:'Платформа й розвиток',copy:'Інструменти для навчання, бізнесу та інтеграцій.',items:[['agents','⬡','Agent Marketplace','AI-агенти з явними дозволами.'],['developer','⌁','Developer Platform','API-ключі, scopes і sandbox.'],['learning','⌬','Science','Навчання, дослідження й конференції.'],['business','◈','Business','Організації та Enterprise control plane.'],...(state.me?.role==='admin'?[['admin','⚙','Moderation','Reports та audit log.']]:[])]}
  ];
  ...
  app.innerHTML=`<section class="settings-scene settings-hero"><div class="settings-copy"><span class="eyebrow">SYLORA · PERSONAL SYSTEM</span><h1>Твій простір керування.</h1><p>Профіль, приватність, Sylora AI та вся екосистема — без прихованих рішень і зайвої складності.</p></div><div class="settings-orbit" aria-hidden="true"><i>✦</i><span></span><span></span><span></span></div></section><div class="settings-groups">${groups.map(group=>`<section class="settings-group"><div class="settings-group-head"><span class="eyebrow">CONTROL GROUP</span><h2>${esc(group.title)}</h2><p>${esc(group.copy)}</p></div><div class="settings-grid">${group.items.map(module).join('')}</div></section>`).join('')}</div>`;
