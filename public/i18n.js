...
const base={
  ...
  password:'Password — at least 8 characters',identity:'Email or username',
...
const dictionaries={
  uk:dict({
    ...
    password:'Пароль — від 8 символів',identity:'Email або username',
  ...
  pl:dict({
    ...
    password:'Hasło — minimum 8 znaków',identity:'Email albo username',
  ...
  de:dict({
    ...
    password:'Passwort — mindestens 8 Zeichen',identity:'E-Mail oder Benutzername',
