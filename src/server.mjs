...
const syloraLive=createSyloraLiveService({ store, openai });
...
async function api(req, res, url) {
  ...
  if (await handleSyloraLiveRoutes({ req, res, url, json, body, requireUser, route, safeText, syloraLive })) return;
