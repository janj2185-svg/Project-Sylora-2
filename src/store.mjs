...
const initial = () => ({
  users: [], sessions: [], passwordResets: [], posts: [], comments: [], reactions: [], commentReactions: [], follows: [], blocks: [], reports: [], presence: {},
  ...
  liveChallenges: [], liveQuizzes: [], liveMiniGames: [], liveStages: [], liveRoomProfiles: [], liveTimers: [], focusSessions: [], callSessions: [], callHistory: [], syloraCalls: [], businessCountryProfiles: [], invoices: [], expenseExtractions: [], crmRecords: [], quotes: [], timeEntries: [], projectBudgets: [], inventoryItems: [], accountantInvites: [], contracts: [], flashcardDecks: [], examPlans: [], assignments: [], quizBuilders: [], smartNotes: [], whiteboards: [], researchLibrary: [], paperNotes: [], researchProjects: [], datasets: [], tutorSessions: [], experimentLogs: [], formulaWorkspaces: [], scienceCircles: [], conferencePrograms: [], sharedQuizzes: [], funSocialRooms: [], communityEvents: [], discoveryProfiles: [], userAchievements: [], seasonalLiveEvents: [],
  liveRtmpDestinations: [], liveViewerMemory: [], liveAutomationRules: [], liveHostControls: [], liveBroadcastPrefs: [], liveModerationPolicies: [], liveSessionArchives: [],
  audit: [], gifts: [
