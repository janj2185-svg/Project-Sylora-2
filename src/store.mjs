...
const initial = () => ({
  ...
  liveChallenges: [], liveQuizzes: [], liveMiniGames: [], liveStages: [], liveRoomProfiles: [], liveTimers: [], focusSessions: [], callSessions: [], callHistory: [], syloraCalls: [], businessCountryProfiles: [], invoices: [], expenseExtractions: [], crmRecords: [], quotes: [], timeEntries: [], projectBudgets: [], inventoryItems: [], accountantInvites: [], contracts: [], flashcardDecks: [], examPlans: [], assignments: [], quizBuilders: [], smartNotes: [], whiteboards: [], researchLibrary: [], researchProjects: [], datasets: [], tutorSessions: [],
  audit: [], gifts: [
