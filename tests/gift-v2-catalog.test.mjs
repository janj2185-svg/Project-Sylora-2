...
import {GIFT_V2_CATALOG,GIFT_V2_PASSPORTS} from '../public/gift-v2/catalog.js';
...
test('canonical Gift V2 runtime export aliases the validated passport catalog',()=>{assert.strictEqual(GIFT_V2_CATALOG,GIFT_V2_PASSPORTS)});
